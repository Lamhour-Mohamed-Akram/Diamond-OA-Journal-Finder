...
function jrowHtml(r){
    ...
    // PJIP Aims & Scope (licensed CC BY-NC; attribution + profile link are part of the agreement with PJIP)
    const pj=typeof pjipOf==='function'?pjipOf(r):null;
    const scopeT=pj?'<details class="jscope"><summary>'+t('Aims & scope')+' <small>'+t('via PJIP')+'</small></summary><p>'+esc(pj.t)+'</p><div class="jscope-src">'+t('Source:')+' <a href="'+esc(pj.u)+'" target="_blank" rel="noopener">PJIP ↗</a> · CC BY-NC 4.0</div></details>':'';
